...
const PALETTE_DEFAULTS = [
  { id: 'dashboard', title: 'Dashboard',        icon: '🏠', hotkey: 'D', href: 'dashboard.html' },
  { id: 'trips',     title: 'Listar viagens',   icon: '✈️', hotkey: 'V', href: 'viagens.html' },
  { id: 'new-trip',  title: 'Nova viagem',      icon: '➕', hotkey: 'N', href: 'nova-viagem.html' },
  ...
  window.addEventListener('keydown', (e) => {
    ...
    if (isMod) {
      switch (e.key.toLowerCase()) {
        case 'n': e.preventDefault(); nav('nova-viagem.html'); break;
        case 'd': e.preventDefault(); nav('dashboard.html'); break;
